...
export function Charts() {
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-2 sm:flex-row sm:p-2">
      <div className="grid w-full gap-1 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[30rem]">
